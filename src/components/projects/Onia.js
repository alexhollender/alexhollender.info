...
const mediaArray = importAll(require.context('@public/media/onia', true, /\.(png|jpe?g|gif|svg)$/));
...
export default function Onia() {
  ...
  return (
    <section>
      ...
      <Link href="https://onia.com" target="_blank" rel="noreferrer">onia.com</Link>
