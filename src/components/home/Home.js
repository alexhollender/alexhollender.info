...
export default function Home() {
  ...
  return (
    <div className={s.intro}>
      ...
      <p>I am currently doing foundational product research and design around a new tool for recipe and food creators, tentatively called <Link href="https://recipe.site/" target="_blank" rel="external"><strong>Recipe.Site</strong></Link>. Below are some of the projects I've worked on.</p>
