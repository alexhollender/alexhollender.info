...
export default function Home() {
  ...
  return (
    <div className={s.intro}>
      <div>Hey, I’m Alex. I’ve been a product designer for the past 10 years. Most recently I led the <Link href="/projects/wiki-2023"><strong>Wikipedia Desktop Redesign</strong></Link>, and before that worked on Wikipedia’s mobile editing tools. During my 5 years at Wikipedia I gained experience around <strong>designing for a global audience</strong> (300+ languages, every device imaginable), <strong>co-designing with an active community of volunteers & users</strong> (editors & technical contributors), <strong>designing for a large audience</strong> (~10 billion monthly pageviews), and <strong>designing around user-generated content</strong>. I love web development, and deep UX research with HTML/JS prototypes is an integral part of my design process.</div>
      ...
      <div className={s.contact}>Currently based in NYC — <Link href="https://www.linkedin.com/in/alex-hollender/" target="_blank" rel="external">linkedin</Link> — alexhollender@gmail.com</div>
    </div>
  )
}