...
export default function Home() {
  ...
  return (
    <div className="max-w-[1000px] font-tobias text-[20px] leading-[165%] max-[1000px]:w-full [&_div]:mb-[20px]">
      ...
      <div className="[&>p]:hidden [&>input]:hidden [&>label]:cursor-pointer [&>label]:font-sans [&>label]:text-[18px] [&:has(input:checked)>label]:hidden [&:has(input:checked)>p]:block">
      ...
      <div className="mt-[50px] font-sans text-[18px] text-gray-text [&_a]:text-gray-text">alexhollender@gmail.com — <Link href="https://www.linkedin.com/in/alex-hollender/" target="_blank" rel="external">linkedin</Link></div>
    </div>
  )
}