    ...
    <>
      ...
      <div id="project-content" className="single-col">
        ...
        <section>
          ...
          <p>As the comments/votes started coming in, I became frustrated at how unrepresentative of the general public the people voting were. It was a very small group of editors, potentially making a decision for billions of readers. It was also unclear if the people who were voting had participated in past discussions, and/or had taken the time to read through the project documentation, research results, data, etc. It seemed like we were getting a lot of first reactions (as it turned out, only ~28 of the 159 people opposing the new interface had previously engaged in discussions, feedback, etc.). There was a lot of arguing about white space and icons, and people simply saying they didn't like it, rather than discussions of real user needs and/or key metrics.</p>
        ...
        <section>
          ...
          <p>While somewhat limited compared with what other websites are able to collect, the data we do have so far paints a picture of positive change:</p>
