    ...
    <>
      ...
      <div id="project-content" className="single-col">
        ...
        <section>
          ...
          <p>In other words, Wikipedia — a major, legacy website (i.e. a top 10 ranked website, for 10+ years) — had an interface that hadn’t been changed for 15 years. And then one day the Chief Product Officer came to our team (1 product manager, ~6 engineers, 1 quality assurance person, ½ a scrum master, ½ a data analyst, ½ a community liaison, and myself), and tasks us with making significant improvements to the website. It might honestly be a once-in-the-history-of-the-internet kind of situation. Exciting and difficult.</p>

          <p>There wasn't one specific reason why, in 2019, this all came about (though there is arguably one person who got the ball rolling — thanks Nirzar). Instead there were a variety of reasons: the line length had no limit, the search box was small and in an unfamiliar place, the table of contents was only available at the top of the page, language switching was hidden, the hierarchy and organization of elements was confusing to some, the front-end was brittle, it was becoming difficult to find places for new features, etc. But perhaps above all was the simple fact that we had been neglecting the interface (due to other priorities, and limited resources), and we felt confident that if we gave it some overdue attention we could make it better for both reader and editors.</p>

          <p>Meanwhile, between 2004 and 2019, the Wikipedia volunteer community had been busy making localized improvements to specific versions of Wikipedia. This is possible because Wikipedia is a democratically run, open-source website, with an interface (and back-end) that can be changed by anyone. And change it they do. But while these changes were real improvements, the majority of them were geared towards logged-in editors, and even the great improvements geared towards readers had not been centralized, so they weren’t available on most Wikipedias. A slight tangent: unbeknownst to many people, the many versions of Wikipedia are not centralized. The Wikipedia you read (whether it’s English, Bengali, Telugu, Navajo, Korean, Norwegian, or any of the 300 others), is actually a separate website from all of the other Wikipedias that exist. Sure they share a lot of code, use the same servers, and generally have the same interface. But changes to the interface (and the content too, of course) are made locally. This meant that the improvement Korean Wikipedia made to have a collapsible sidebar didn’t carry over to English Wikipedia (or anywhere else), the changes Hebrew Wikipedia made to have a sticky header didn’t carry over to Burmese Wikipedia, and on and on.</p>
        ...
        <section>
          ...
          <p>Coming out on the other side of this project, I strongly believe that fully interactive prototypes (versus mockups, or even a click-through prototypes), communicate designs significantly more clearly, and facilitate higher quality discussions and feedback. Below is a list of all of the prototypes I ended up building.</p>

          <details>
            <summary>List of prototypes</summary>
            List of prototypes
          </details>
        </section>
        ...
        <section>
          ...
          <p>One big question was: should we make the table of contents a fixed sidebar (which is a common pattern), or keep the table of contents inline, and then add a supplemental table of contents that appears once you’ve scrolled past the inline one? With an inline table of contents you get as much space as you need to display it — long section headings, and many levels of nested sub-headings don’t present an issue. I.e. you can display the fully expanded table of contents (though on long articles it often takes up your entire screen). However it appears below the lead section, which means that sometimes when you land on the page you can't see the table of contents at all without scrolling (depending on the length of the lead section and the width of your screen). When the table of contents in a sidebar you are much more spatially constrained, however the big upside is that it’s immediately visible when you land on the page, and always remains in the same place. We ran extensive user testing on 5 different options (<a href="https://di-toc-supplementary.web.app/Sushi" target="_blank">1</a>, <a href="https://di-toc-floating.web.app/Frankenstein" target="_blank">2</a>, <a href="https://di-toc-supplementary-2.web.app/Indian_Ocean" target="_blank">3</a>, <a href="https://di-toc-expandable.web.app/Hydrogen" target="_blank">4</a>, <a href="https://di-toc-back-to-top.web.app/Moss" target="_blank">5</a>), in 3 countries, and the results were thankfully clear: make it a fixed sidebar. Another fairly big decision we made was to collapse sub-sections in the table of contents for longer articles. Sometimes, when an article has many sections and sub-sections, the table of contents is very tall, and you are unable to see all of it without scrolling the page. By collapsing sub-sections for articles with <i>more than 28 sections total</i>, you can see all top-level sections within the table of contents without scrolling. This allows you to quickly learn the contents of the entire page, at a high-level.</p>
          ...
          <ul>
            ...
            <li>Should all of the sections be expanded or collapsed by default? And if collapsed, should we have an “expand all” button? (<a href="https://di-toc-expand-collapse-all.web.app/Mount_Fuji" target="_blank">prototype link</a>)</li>
        ...
        <section>
          ...
          <p>As I mentioned before, Wikipedia is a democratically run project. Many decisions are made through a consensus process. Exactly who has what power, and how to move forward amidst disagreement is often unclear. Because we were trying to represent the needs of billions of readers, who do not participate in Wikipedia’s democratic process, we knew we would bump up against friction (some of which can be helpful). At the beginning of the project we asked a few Wikipedias to be early adopters of our changes (Basque, French, Hebrew, Persian, and others). That meant, for those "pilot" Wikipedias all changes we made were released by default to all logged-in <i>and</i> logged-out people (though logged-in people, who are typically editors, could opt-out if they wanted). So if you use/used one of those Wikipedias, you would have seen the changes we made happen gradually, over the past couple of years. This gave us usability feedback, and also served as a quasi-A/B test. Our hope was, if we could develop an interface that worked for thousands of editors and millions of readers, and prove it through data and low opt-out rates, we could get the rest of the Wikipedia communities on board. For all of the other Wikipedia communities, while they were involved all along — over 2,000 volunteers participated in the development process, reviewing prototypes, helping us design features, giving feedback, etc. — their usage of the new interface was opt-in.</p>

          <p>Almost every day I would interact with volunteers from large Wikipedia communities, on our project <a href="https://www.mediawiki.org/wiki/Talk:Reading/Web/Desktop_Improvements" target="_blank">message board</a>, publicly available <a href="https://phabricator.wikimedia.org/tag/desktop_improvements_vector_2022/" target="_blank">Phabricator tasks</a>, in chat rooms, and at hackathons and other Wikipedia events. We also had five formal, asynchronous feedback collection events throughout the project (<a href="https://www.mediawiki.org/wiki/Reading/Web/Desktop_Improvements/Community_interactions_overview#Prototype_feedback_events" target="_blank">link</a>). Since their feedback on each of the changes along the way was largely positive, and all of our data from our test Wikipedias looked great (only ~10% of editors on our pilot Wikipedias opted out), we hoped that when we eventually asked the communities they would each adopt the redesigned interface. Alas, English Wikipedia (by far the largest), wanted to hold an <a href="https://en.wikipedia.org/wiki/Wikipedia:Requests_for_comment" target="_blank">RfC</a> (Request for Comment), which is a longstanding Wikipedia process that is somewhere in between a vote and a discussion (<a href="https://en.wikipedia.org/wiki/Wikipedia:Requests_for_comment/Deployment_of_Vector_(2022)" target="_blank">link to the RfC</a>).</p>
          ...
          <p>As the votes started coming in I became frustrated at how unrepresentative of the general public the people voting were. It was a very small group of editors potentially making a decision for billions of readers. It was also unclear if the people who were voting (and particularly the people who were opposing the redesign) had participated in past discussions, and/or had taken the time to read through the project documentation, research results, data, etc. It seemed like we were getting a lot of first reactions. There was a lot of arguing about white space and icons, and people simply saying they didn't like it, rather than discussions of real user needs and/or key metrics.</p>

          <p>The discussion/vote lasted for a month, was nearly tied in the end (154 support, 165 oppose), but thankfully the final judgment (which is called a “closing”, and is done by a volunteer) approved the redesign. Compared with other RfCs this was a big success. The volunteer communities are generally very change-averse (in some ways for good reason), and changes developed by the Wikimedia Foundation staff members can be particularly challenging to get acceptance for. However I was still left feeling a bit weirdly about the vote. Did we just get lucky? Did all of those previous interactions we had with volunteers actually build support? Did all of the feedback we incorporated lead to a better design? And why do people think whitespace is an indication of a failed design (like holy shit, some people hate it so much)?</p>
          
          <p>The outcome of the RfC was probably a mix of all of those things, but we won’t really ever know how/why we arrived at a positive outcome, which is bothersome to me. I was happy to see some small discussions within the RfC regarding the validity of the RfC process for making such large decisions. In general I think it also highlighted the lack of alignment in terms of development priorities between some of the community members and the Wikimedia Foundation, and the need for more analytics and data. I have many more thoughts on ways we might evolve the RfC process, and the systems of governance on Wikipedia in general, which I’ll save for another time.</p>

          <p>(Addendum: after the launch some people on English Wikipedia started another RfC, about rolling back the redesign. You can read that RfC <a href="https://en.wikipedia.org/wiki/Wikipedia:Requests_for_comment/Rollback_of_Vector_2022" target="_blank">here</a>.)</p>
        </section>

        <section>
          <h3>Reader → informed reader</h3>
          <p>Have you ever wondered whether or not a Wikipedia article was accurate, or more generally if you can trust Wikipedia? What many people don’t understand is that Wikipedia articles <a href="https://en.wikipedia.org/wiki/Wikipedia:No_original_research" target="_blank">don’t contain original thoughts or opinions</a>. In a sense they aren’t even really “written”, or at least not in the way that someone might write an essay or a poem. Instead Wikipedia articles are collages of facts that credible researchers have published about a given topic elsewhere. Think of a little puzzle, or a quilt, with each piece being a fact about the topic that was previously published by a credible institution. With this in mind it becomes clear that any Wikipedia article is only as accurate as the sources from which the facts were gathered. You can of course question the motives or skill level of the editors, who are the ones going out, gathering the facts, and then weaving them together into coherent articles. But ultimately Wikipedia is a container filled with facts, rather than a blank page upon which people have written whatever they want about a topic.</p>

          <p>During the project we became interested in how the interface could better communicate this meta-information about Wikipedia articles. How might we help people understand that editors are more fact-gatherers than authors, that they had long, involved disputes over whether or not a source was credible, and that they actively watched articles in order to ensure that any information added to them was coming from a credible source? How could we expose this dynamic, living system that is currently nearly invisible to most readers, in a way that would empower them to better evaluate the credibility of a given article? What if the “reading experience” of Wikipedia wasn’t just about reading the content, but also being able to read an article in this meta way? Could we help people grow from being <i>content readers</i>, to more <i>informed readers</i>? Partly inspired by the <a href="https://winter.toolforge.org/" target="_blank">Winter prototype</a>, I made some sketches of Wikipedia articles that included various pieces of metadata, which might serve as little clues as to what was going on. I then thought about some kind of article activity & metadata summary, that would quickly give people a sense of the state of an article with regards to editor activity as well as credibility.</p>
        ...
        <section>
          <p>That’s all I’ve managed to type up so far. I hope some parts of our process and project can be usefully borrowed by others, and that people reach out to me to learn more about the process and specific changes/decisions that we made. I’ve also begun to compile a list of responses to specific UI/UX questions that people might have, which can be found here: <a href="https://www.mediawiki.org/wiki/Skin:Vector/2022/Design_documentation" target="_blank">design documentation</a>.</p>

          <p>Cheers,<br></br>alexhollender@gmail.com</p>
        </section>

        <hr></hr>

        <section id="credits">
          <p>The project was carried out by the Web Team at the Wikimedia Foundation, with continual support from the Research & Design Team at the Wikimedia Foundation.</p>
