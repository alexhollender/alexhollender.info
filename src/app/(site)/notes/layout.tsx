...
const notesClass = [
  ...
  '[&_h1]:text-display [&_h1]:leading-[125%] [&_h1]:mb-[20px]',
  '[&_h2]:text-title [&_h2]:leading-[1.8] [&_h2]:mt-[44px] [&_h2]:mb-[14px]',
  '[&_h3]:text-2xl [&_h3]:leading-[1.8] [&_h3]:mt-[30px] [&_h3]:mb-[16px]',
  // text
  ...
  '[&_.gridContainer]:max-w-[600px] [&_.gridContainer]:grid [&_.gridContainer]:grid-cols-[1fr_50px_1fr] [&_.gridContainer]:gap-0 [&_.gridContainer]:border [&_.gridContainer]:border-[black] [&_.gridContainer]:border-b-0 [&_.gridContainer]:text-fine',
