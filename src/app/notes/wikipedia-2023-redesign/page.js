...
export default function Wikipedia2023RedesignNotes() {
  return(
    ...
    <section>
      ...
      <p>In 2010, a bunch of changes were made to increase the usability of Wikipedia for new editors (<Link href="https://usability.wikimedia.org/wiki/Wikipedia_Usability_Initiative" target="_blank" rel="external">notes</Link>), and in 2015 the editing experience was again significantly improved with the introduction of the <Link href="https://www.mediawiki.org/wiki/VisualEditor" target="_blank" rel="external">Visual Editor</Link>. However, the general layout, and specifically the reading experience, stayed largely the same between the 2004 update, and 2019, where my team’s involvement begins (the <Link href="https://www.mediawiki.org/wiki/Reading/Web" target="_blank" rel="external">Readers Web Team</Link> at the Wikimedia Foundation — an organization of paid staff members who work on things like the Wikipedia apps, search, languages & translations, editing software, community wishlist, machine learning, and more).</p>
    ...
    <section>
      ...
      <p>With a mix of intuition, interviews, research, team meetings, looking at all of the stuff volunteers had modified (including <Link href="https://winter.toolforge.org/" target="_blank" rel="external">proposals that never got built</Link>, and cool <Link href="https://github.com/Krasjet/wikipedia.rehash" target="_blank" rel="external">Wikipedia plugins</Link>), and reading tarot cards, we started to establish a sense of priorities for the interface:</p>
    ...
    <section>
      ...
      <p>When the project started I built a <Link href="https://vector-2022.web.app/Moss" target="_blank" rel="external">base prototype</Link> (<Link href="https://github.com/alexhollender/wikipedia-prototype" target="_blank" rel="external">code</Link>), which was the Wikipedia interface hooked up to a few APIs so I could load any article (with its table of contents), in any language, as well as use the search box and get live search suggestions. I then added the ability to switch the interface itself (all of the buttons, links, etc.) to various languages. For each feature/design decision I would build a new prototype on top of that base, exploring the question(s) at hand. The prototypes often included a little settings panel in the bottom corner that allowed you to toggle between the various options being explored. Here is a relatively simple one that explores various ways of indicating the active section in the table of contents (<Link href="https://di-visual-design-toc-active.web.app/Okapi" target="_blank" rel="external">link</Link>):</p> 
    ...
    <section>
      <h3>Visual design</h3>
      <p>If you look at <Link href="https://www.mediawiki.org/wiki/Reading/Web/Desktop_Improvements/Repository/A_History_of_Wiki_Skins" target="_blank" rel="external">past versions</Link> of the Wikipedia interface, you’ll notice that each version has a personality of sorts. A unique color, border style, subtle background image, tab style, or other such eccentricities. At first I felt a bit of a pressure to keep with this tradition, and come up with a new personality. Kieran, Roy, Angy, and myself starting by playing around with borders, buttons, gradients, icons, typography, and other elements:</p>
      ...
      <p>However it's difficult to determine how much visual separation is sufficient, and what the tradeoffs are for adding more. I created this <Link href="https://di-visual-design-borders-bgs.web.app/Zebra" target="_blank" rel="external">prototype</Link> (shown below) with various options for separating the parts of the interface in order to discuss with the community. Some people felt that more separation is always better — that reading experience, as well as the general comprehension of the interface, improves. The discussion happened <Link href="https://phabricator.wikimedia.org/T259240" target="_blank" rel="external">here</Link> for the most part. There was some consensus around a version that became known as "zebra", which the team eventually was able to A/B test (<Link href="https://phabricator.wikimedia.org/T335379" target="_blank" rel="external">results here</Link>).</p>
      ...
      <p><Link href="https://di-visual-design-borders-bgs.web.app/Zebra" target="_blank" rel="external">Link to prototype</Link></p>
    </section>
    ...
    <section>
      ...
      <ul>
        <li>When you scroll to a section that has collapsed sub-sections, should the parent section automatically expand? (<Link href="https://di-toc-section-auto-expand.web.app/Paris" target="_blank" rel="external">prototype link</Link>)</li>
        ...
        <li>Should we have an “expand all” button for articles with collapsed sub-sections? (<Link href="https://di-toc-expand-collapse-all.web.app/Mount_Fuji" target="_blank" rel="external">prototype link</Link>)</li>
        <li>Should we continue hiding the table of contents on articles with less than 4 sections? (<Link href="https://phabricator.wikimedia.org/T318186" target="_blank" rel="external">task link</Link>)</li>
      </ul>

      <p>You can read about more of the details and rationales <Link href="https://www.mediawiki.org/wiki/Skin:Vector/2022/Design_documentation#Table_of_contents" target="_blank" rel="external">here</Link></p>
    </section>
    ...
    <section>
      ...
      <p>Almost every day I would interact with volunteers from various Wikipedia communities, big and small, on our project's <Link href="https://www.mediawiki.org/wiki/Talk:Reading/Web/Desktop_Improvements" target="_blank" rel="external">message board</Link>, publicly available <Link href="https://phabricator.wikimedia.org/tag/desktop_improvements_vector_2022/" target="_blank" rel="external">Phabricator tasks</Link>, in chat rooms, and occationally at hackathons and other Wikipedia events. We also had five formal, asynchronous feedback collection events throughout the project (<Link href="https://www.mediawiki.org/wiki/Reading/Web/Desktop_Improvements/Community_interactions_overview#Prototype_feedback_events" target="_blank" rel="external">link</Link>). Since their feedback on each of the changes along the way was largely positive, and all of our data from our test Wikipedias looked great (only ~13% of editors on our pilot Wikipedias opted out), we hoped that when we eventually asked the other communities, they would each adopt the redesigned interface. Alas, English Wikipedia (by far the largest), wanted to hold an <Link href="https://en.wikipedia.org/wiki/Wikipedia:Requests_for_comment" target="_blank" rel="external">RfC</Link> (Request for Comment), which is a longstanding Wikipedia process that is somewhere in between a vote and a discussion (<Link href="https://en.wikipedia.org/wiki/Wikipedia:Requests_for_comment/Deployment_of_Vector_(2022)" target="_blank" rel="external">link to the RfC</Link>).</p>
    ...
    <section>
      <p>That’s all I’ve managed to type up so far. I hope some parts of our process can be usefully borrowed by others, and that people reach out to me to learn more about the process, challenges, and specific changes/decisions that we made. I’ve also begun to compile a list of responses to specific UI/UX questions that people might have, which can be found here: <Link href="https://www.mediawiki.org/wiki/Skin:Vector/2022/Design_documentation" target="_blank" rel="external">design documentation</Link>. For reference, here's a link to the <Link href="https://en.wikipedia.org/wiki/Surfing?useskin=vector" target="_blank" rel="external">previous version</Link> of the interface, which is still available to all logged-in editors via Settings. And yes,we should increase the font-size to 16px.</p>
